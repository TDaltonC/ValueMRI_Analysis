...
#       make the three column format eventfile [onsetTime, Durration, Magnitude]
        ...
        scalingSISDifficulty3Col = trialByTrial[(trialByTrial.Opt1Type == 2) & (trialByTrial.Run  == run) & (trialByTrial.OptValue  == trialByTrial.OptValue) & (trialByTrial.SIS  == 1)][['ReactionTime','OptValueDiff']]
        ...
        scalingCVDifficulty3Col = trialByTrial[(trialByTrial.Opt1Type == 2) & (trialByTrial.Run  == run) & (trialByTrial.OptValue  == trialByTrial.OptValue) & (trialByTrial.SIS  == 0)][['ReactionTime','OptValueDiff']]
        ...
        bundlingSISDifficulty3Col = trialByTrial[(trialByTrial.Opt1Type == 3) & (trialByTrial.Run  == run) & (trialByTrial.OptValue  == trialByTrial.OptValue) & (trialByTrial.SIS  == 1)][['ReactionTime','OptValueDiff']]
        ...
        bundlingCVDifficulty3Col = trialByTrial[(trialByTrial.Opt1Type == 3) & (trialByTrial.Run  == run) & (trialByTrial.OptValue  == trialByTrial.OptValue) & (trialByTrial.SIS  == 0)][['ReactionTime','OptValueDiff']]
...
#       De-Mean the parametric pregressors
        ...
        scalingSISDifficulty3Col['OptValueDiff'] = scalingSISDifficulty3Col['OptValueDiff'] - scalingSISDifficulty3Col['OptValueDiff'].mean()

        scalingCVValue3Col['OptValue'] = scalingCVValue3Col['OptValue'] - scalingCVValue3Col['OptValue'].mean()
        scalingCVDifficulty3Col['OptValueDiff'] = scalingCVDifficulty3Col['OptValueDiff'] - scalingCVDifficulty3Col['OptValueDiff'].mean()
        
        bundlingSISValue3Col['OptValue'] = bundlingSISValue3Col['OptValue'] - bundlingSISValue3Col['OptValue'].mean()
        bundlingSISDifficulty3Col['OptValueDiff'] = bundlingSISDifficulty3Col['OptValueDiff'] - bundlingSISDifficulty3Col['OptValueDiff'].mean()

        bundlingCVValue3Col['OptValue'] = bundlingCVValue3Col['OptValue'] - bundlingCVValue3Col['OptValue'].mean()
        bundlingCVDifficulty3Col['OptValueDiff'] = bundlingCVDifficulty3Col['OptValueDiff'] - bundlingCVDifficulty3Col['OptValueDiff'].mean()
...
#       Name and open the destinations for event files
        ...
        scalingSISDifficultyDir  = safe_open_w(data_dir + '/Models/' + modelName + '/EventFiles/' + subjectID + '/RUN' + str(run) + '/ScalingSISDifficulty.run00'+ str(run) +'.txt')
        ...
        scalingCVDifficultyDir  = safe_open_w(data_dir + '/Models/' + modelName + '/EventFiles/' + subjectID + '/RUN' + str(run) + '/ScalingCVDifficulty.run00'+ str(run) +'.txt')
        ...
        bundlingSISDifficultyDir = safe_open_w(data_dir + '/Models/' + modelName + '/EventFiles/' + subjectID + '/RUN' + str(run) + '/BundlingSISDifficulty.run00'+ str(run) +'.txt')
        ...
        bundlingCVDifficultyDir = safe_open_w(data_dir + '/Models/' + modelName + '/EventFiles/' + subjectID + '/RUN' + str(run) + '/BundlingCVDifficulty.run00'+ str(run) +'.txt')
...
#       Be Tidy! Close all of those open files! 
        ...
        scalingSISDifficultyDir.close()

        scalingCVDir.close()
        scalingCVValueDir.close()
        scalingCVDifficultyDir.close()

        bundlingSISDir.close()
        bundlingSISValueDir.close()
        bundlingSISDifficultyDir.close()

        bundlingCVDir.close()
        bundlingCVValueDir.close()
        bundlingCVDifficultyDir.close()
