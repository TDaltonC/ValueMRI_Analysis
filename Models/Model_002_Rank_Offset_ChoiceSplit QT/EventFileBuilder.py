...
modelName = "Model_002_Rank_Offset_ChoiceSplit"
...
#       make the three column format eventfile [onsetTime, Durration, Magnitude]
        ...
        controlPosValue3Col = trialByTrial[(trialByTrial.Opt1Type == 1) & (trialByTrial.Run  == run) & (trialByTrial.Choice == 1) & (trialByTrial.OptValue  == trialByTrial.OptValue)][['ReactionTime','OptValueOff']]
        controlNegValue3Col = trialByTrial[(trialByTrial.Opt1Type == 1) & (trialByTrial.Run  == run) & (trialByTrial.Choice == 2) & (trialByTrial.OptValue  == trialByTrial.OptValue)][['ReactionTime','OptValueOff']]        
        
        scaling3Col = trialByTrial[(trialByTrial.Opt1Type == 2) & (trialByTrial.Run  == run)][['ReactionTime','ones']]
        scalingPosValue3Col = trialByTrial[(trialByTrial.Opt1Type == 2) & (trialByTrial.Run  == run) & (trialByTrial.Choice == 1) & (trialByTrial.OptValue  == trialByTrial.OptValue)][['ReactionTime','OptValueOff']]
        scalingNegValue3Col = trialByTrial[(trialByTrial.Opt1Type == 2) & (trialByTrial.Run  == run) & (trialByTrial.Choice == 2) & (trialByTrial.OptValue  == trialByTrial.OptValue)][['ReactionTime','OptValueOff']]
        
        bundling3Col = trialByTrial[(trialByTrial.Opt1Type == 3) & (trialByTrial.Run  == run)][['ReactionTime','ones']]
        bundlingPosValue3Col = trialByTrial[(trialByTrial.Opt1Type == 3) & (trialByTrial.Run  == run) & (trialByTrial.Choice == 1) & (trialByTrial.OptValue  == trialByTrial.OptValue)][['ReactionTime','OptValueOff']]
        bundlingNegValue3Col = trialByTrial[(trialByTrial.Opt1Type == 3) & (trialByTrial.Run  == run) & (trialByTrial.Choice == 2) & (trialByTrial.OptValue  == trialByTrial.OptValue)][['ReactionTime','OptValueOff']]
