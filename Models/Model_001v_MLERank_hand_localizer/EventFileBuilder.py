...
#       make the three column format eventfile [onsetTime, Durration, Magnitude]
        ...
        left3Col = trialByTrial[(trialByTrial.Left  == 1) & (trialByTrial.Run  == run)][['ReactionTime','Left']]
        right3Col= trialByTrial[(trialByTrial.Right  == 1) & (trialByTrial.Run  == run)][['ReactionTime','Right']]
