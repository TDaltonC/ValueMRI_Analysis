...
cont15= ['ControlReactionTime','T', ['ControlReactionTime'],[1]]
cont16= ['ScalingReactionTime','T', ['ScalingReactionTime'],[1]]
cont17= ['BundlingReactionTime','T', ['BundlingReactionTime'],[1]]

cont18= ['ControlReactionTime>ScalingReactionTime','T', ['ControlReactionTime','ScalingReactionTime'],[1,-1]]
cont19= ['ControlReactionTime>BundlingReactionTime','T', ['ControlReactionTime','BundlingReactionTime'],[1,-1]]
cont20= ['ScalingReactionTime>BundlingReactionTime','T', ['ScalingReactionTime','BundlingReactionTime'],[1,-1]]

cont21= ['Control>Scaling','T', ['Control','Scaling'],[1,-1]]
cont22= ['Control>Bundling','T', ['Control','Bundling'],[1,-1]]
cont23= ['Scaling>Bundling','T', ['Scaling','Bundling'],[1,-1]]
cont24= ['Control>Scaling+Bundling','T', ['Control','Scaling','Bundling'],[1,-.5,-.5]]
