...
modelName = "Model_001v_MLERank_Chosen"
...
#       make the three column format eventfile [onsetTime, Durration, Magnitude]
        ...
        value3Col = trialByTrial[(trialByTrial.OptValue  == trialByTrial.OptValue) & (trialByTrial.Run  == run)][['ReactionTime','chosenValue']]
...
#       De-Mean the parametric pregressors
        value3Col['OptValue'] = value3Col['chosenValue'] - value3Col['chosenValue'].mean()
