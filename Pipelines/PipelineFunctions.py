...
def FLWS(modelName = "Model_002_LB_DiffOnly"):
    ...
    outgraph = masterpipeline.run(plugin='MultiProc', plugin_args={'n_procs': (PC.CPU_Count-1)})
...
def BS(modelName = "Model_002_LB_DiffOnly"):
