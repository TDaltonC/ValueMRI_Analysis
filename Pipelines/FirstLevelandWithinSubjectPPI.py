...
modelspec = pe.Node(interface=model.SpecifyModel(input_units = "scans",
...
withinSubject.connect([
                       # (modelfit,datasink,[('modelestimate.param_estimates','regressorEstimates')]),
